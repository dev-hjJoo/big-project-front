...
const StandardResultBox = () => (
    <GBox className="ocr-result" style={{ textAlign: 'left' }}>
        <h3>근로계약서 검토 결과</h3>
        <Divider />
        <ol>
            <li>
                <div className='title'>근로계약기간</div>
                <ul>
            ...
            <li>
                <div className='title'>근무장소</div>
                <ul>
                    <li>일을 수행하기 위한 장소를 명기합니다.</li>
                </ul>
            </li>
            <li>
                <div className='title'>업무의 내용</div>
                <ul>
                    <li>어떤 일을 할지에 대한 내용을 기재합니다.</li>
                </ul>
            </li>
            <li>
                <div className='title'>소정근로시간</div>
                <ul>
            ...
            <li>
                <div className='title'>연차유급휴가</div>
                <ul>
            ...
            <li>
                <div className='title'>사회보험 적용여부</div>
                <ul>
                    <li>사회보험 적용에 대한 해당 내용을 기재합니다.</li>
                </ul>
            </li>
            <li>
                <div className='title'>근로계약서 교부</div>
                <ul>
            ...
            <li>
                <div className='title'>근로계약, 취업규칙 등의 성실한 이행 의무</div>
                <ul>
            ...
            <li>
                <div className='title'>사업주</div>
                <ul>
                    <li>사업체명, 전화번호, 주소, 대표자를 명시하며, 서명을 해야 합니다.</li>
                </ul>
            </li>
            <li>
                <div className='title'>근로자</div>
                <ul>
